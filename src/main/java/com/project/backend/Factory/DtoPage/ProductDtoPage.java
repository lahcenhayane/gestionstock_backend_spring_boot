...
public class ProductDtoPage extends Page<ProduitDTO> {
    public ProductDtoPage(List<ProduitDTO> list, int totalPage, long totalRow) {
    ...
    @Override
    public void setList(List<ProduitDTO> list) {
        super.setList(list);
    }
