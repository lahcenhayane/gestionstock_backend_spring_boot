...
public class CategorieResponsePage extends Page<CategorieResponse> {
    public CategorieResponsePage(List<CategorieResponse> list, int totalPage, long totalRow) {
        super(list, totalPage, totalRow);
    }

    @Override
    public List<CategorieResponse> getList() {
        return super.getList();
    }

    @Override
    public void setList(List<CategorieResponse> list) {
        super.setList(list);
    }
